...
public class UD19ejemplo02botonmensaje extends JFrame {
    
    public UD19ejemplo02botonmensaje() {
        ...
        boton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                JOptionPane.showMessageDialog(UD19ejemplo02botonmensaje.this, 
                		"Enviado, gracias");
            }
        });
    ...
    public static void main(String[] args) {
    	...
    	UD19ejemplo02botonmensaje ventana = new UD19ejemplo02botonmensaje();
