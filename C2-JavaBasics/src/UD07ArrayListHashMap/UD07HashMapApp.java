...
public class UD07HashMapApp {

	public static void main(String[] args) {
		// Crear un HashMap con clave de tipo String y valor de tipo Integer
		HashMap<String, Integer> edadesAlumnos = new HashMap<>(); // edadesAlumnos = {}
		...
		System.out.printf("Las edades son %d %d  %d %n", edadDeJuan, edadDeMaria,edadDePedro);

		// Iterar sobre las claves del HashMap
		System.out.println("Claves en el edadesAlumnos:");
		for (String alumno : edadesAlumnos.keySet()) {
